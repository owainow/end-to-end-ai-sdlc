...
from src.presentation.schemas import ForecastDayResponse, ForecastResponse, WeatherResponse
...
@router.get(
    ...
    description="Retrieve multi-day weather forecast data for a specified city or coordinates.",
    responses={
